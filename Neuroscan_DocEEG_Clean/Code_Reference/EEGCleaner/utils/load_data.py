...
def load_data(file_path):
    ...
    if n_channels == 62:
        ch_62_name = np.genfromtxt('./珠江医院_音乐治疗数据/_dot_MusicTherapy_62EEG_1ECG_1Sync.txt', dtype=str,
                                   delimiter=',',
                                   usecols=[3]).tolist()
